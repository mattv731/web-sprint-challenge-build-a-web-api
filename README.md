...
Node.js has the ability to write server-side code with the familiar JS code we've already been learning. Express is a framework to make it easier to create servers.

1. Understand and explain the use of Middleware.

Middleware is used for different things like modifying data, varifying, or even just showing what data is being passed through. There are built-in middleware, custom middleware, and third-party middleware.

1. The basic principles of the REST architectural style.

Everything is a resource.
Resources are available through a URI
Resources can have multiple representations
Communication is done over the stateless protocol (HTTP)
Management is done through HTTP methods

1. Understand and explain the use of Express Routers.

Express Router allows for more readability in your code through breaking it down into smaller chuncks.
It also simplifies your code by getting ride of the need for Routes

1. Describe tooling used to manually test the correctness of an API.

Postman is one of the tools you can use to manually test your api. It allows your to test full crud on your app.
